...
def test_forecast_response_separation_fields():
    """Verify observed vs future forecasted price structures are separate and correct."""
    data = {
        ...
        "forecast": [
            {
                ...
                "forecast_timestamp": "2026-07-29T12:00:00Z",
        ...
        "recommendation": {
            "decision": "BOOK_NOW",
            "reasons": ["Forecast is higher than current lowest fare."],
            "confidence": 75.0
        },
        "confidence": 75.0,
        "search_metadata": {
    ...
    assert resp.predicted_price == 5500.0
    assert resp.forecast[0].forecast_price == 5500.0
    assert resp.prediction_horizon == 3
