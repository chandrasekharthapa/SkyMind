    ...
    <>
        ...
        <div style={{ width:'100%', maxWidth:'1160px', margin:'0 auto', padding:'0 20px', display:'flex', alignItems:'stretch' }}>
          ...
          <div className="nav-links-desktop" style={{ display:'flex', alignItems:'center', marginLeft:'auto', borderLeft:'1px solid #efefed' }}>
            ...
            <Link href="/flights" style={{
              padding:'0 20px', height:'100%', background:'#e8191a', color:'#fff',
          ...
          <div className="nav-mobile-menu" style={{ marginLeft:'auto', alignItems:'center', gap:'12px' }}>
            ...
            <button
              ...
              style={{ background:'none', border:'none', cursor:'pointer', padding:'8px', color:'#131210', display:'flex', flexDirection:'column', gap:'5px' }}
              aria-label="Menu"
            >
      ...
      {mobileOpen && (
        <div style={{
          ...
          {links.map(l => {
            ...
            return (
              <Link key={l.href} href={l.href} style={{
                ...
                borderLeft: active ? '3px solid #e8191a' : '3px solid transparent',
              }}>
                {l.label}
              </Link>
            )
          ...
          <Link href="/flights" style={{
            display:'block', padding:'16px 20px', margin:'12px',
            background:'#e8191a', color:'#fff', textAlign:'center',
