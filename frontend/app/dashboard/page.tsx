...
const DEMO_BOOKINGS = [
  { id: "1", booking_reference: "SKY26J4R2X", status: "CONFIRMED", origin_code: "DEL", destination_code: "DXB", total_price: 28450, created_at: new Date().toISOString() },
  { id: "2", booking_reference: "SKY26K1M7P", status: "PENDING",   origin_code: "BOM", destination_code: "LHR", total_price: 52300, created_at: new Date().toISOString() },
];

const DEMO_ALERTS = [
  { id: "1", origin_code: "DEL", destination_code: "DXB", departure_date: "2026-05-15", target_price: 26000, last_price: 24100, triggered_count: 1 },
  { id: "2", origin_code: "BOM", destination_code: "SIN", departure_date: "2026-07-10", target_price: 18000, last_price: 22400, triggered_count: 0 },
];
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        if (mounted) { setBookings(DEMO_BOOKINGS); setAlerts(DEMO_ALERTS); }
      } finally {
        ...
        <div className="dash-header">
          <div className="wrap">
            <div className="dash-title-row">
              <div>
                <div style={{ fontFamily: "var(--fm)", fontSize: ".65rem", fontWeight: 500, letterSpacing: ".14em", textTransform: "uppercase", color: "var(--grey3)", marginBottom: "10px" }}>
                ...
                <div className="dash-tier">
                  ...
                  <span className="points">SkyMind Points</span>
                </div>
              </div>
          ...
          <div style={{ marginTop: "28px" }}>
            <div className="dash-stats">
              {[
                ...
                { icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="8" r="6" /><path d="M15.477 12.89L17 22l-5-3-5 3 1.523-9.11" /></svg>, val: "0", label: "Points" },
              ].map(s => (
                    ...
                    <div className="bk-body">
                      <div className="bk-route">
                        ...
                        <div className="fline" style={{ flex: 1, margin: "0 12px" }}>
                          ...
                          <div className="fline-track" style={{ flex: 1 }}><div className="fline-plane">{PLANE}</div></div>
                          <div className="fline-dot" />
                        </div>
                  ...
                  {alerts.map(a => (
                    <div key={a.id} className="alert-item">
                      <div className="alert-route">
                        ...
                        <span style={{ marginLeft: "auto", width: "6px", height: "6px", borderRadius: "50%", background: a.triggered_count > 0 ? "#22c55e" : "#f59e0b", display: "inline-block" }} />
                      </div>
